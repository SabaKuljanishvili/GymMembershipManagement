        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GymClassName = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Schedule_GymClasses_GymClassId",
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "MembershipTypeName" },
                values: new object[,]
                {
                    { 1, "Monthly" },
                    { 2, "Yearly" },
